...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/nv/gh9887jn13jcqv7y0lrsj_400000gn/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/bsung/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/bsung/.mailcheckrc"
# }
